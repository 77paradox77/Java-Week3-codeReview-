...
public class AppTest extends FluentTest {
  ...
  public void clientsIsDisplayedTest() {
    Stylist stylist = new Stylist("Summer");
    stylist.save();
    goTo("http://localhost:4567/stylists/" + stylist.getId() + "/clients/new");
    fill("#client-name").with("Spielberg");
    submit(".btn");
    click("a", withText("View Clients"));
    assertThat(pageSource()).contains("Spielberg");
  }
